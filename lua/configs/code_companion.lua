...
require("codecompanion").setup {
    ...
    strategies = {
        chat = {
            adapter = "gemini",
            roles = {llm = "CodeCompanion", user = "towjacix"}
        },
...
5. Provide context on how the code fits into a larger application if applicable.]],
                    ...
                    content = function(context)
                        ...
                        return fmt([[Please explain this code from buffer %d:

```%s
%s
```
]], context.bufnr, context.filetype, code)
                    end,
...
Use Markdown formatting and include the programming language name at the start of the code block.]],
                    ...
                    content = function(context)
                        ...
                        return fmt([[Please fix this code from buffer %d:
            ...
            prompts = {
                {
                    ...
                    content = function(context)
                        local selection = require(
                                              "codecompanion.helpers.actions").get_code(
                                              context.start_line,
                                              context.end_line)
            ...
            prompts = {
                {
                    ...
                    role = constants.USER_ROLE,
                    content = function(context)
                        local diagnostics = require(
                                                "codecompanion.helpers.actions").get_diagnostics(
                                                context.start_line,
                                                context.end_line, context.bufnr)
...
%s
]], context.filetype, concatenated_diagnostics)
                    end
                }, {
                    role = constants.USER_ROLE,
                    content = function(context)
