...
map("n", "<leader>fzf", "<cmd>FZF<CR>", {desc = "Files fuzzy search"})
map("n", "<C-h>", "<C-w>h", {desc = "Switch Window left"})
map("n", "<C-l>", "<C-w>l", {desc = "Switch Window right"})
map("n", "<C-j>", "<C-w>j", {desc = "Switch Window down"})
map("n", "<C-k>", "<C-w>k", {desc = "Switch Window up"})
map("n", "<leader>fb", require("browser_bookmarks").select,
    {desc = "Fuzzy search browser bookmarks"})
map("n", "<C-s>", "<cmd>w<CR>", {desc = "File Save"})
map("n", "<C-c>", "<cmd>%y+<CR>", {desc = "File Copy whole"})
map("n", "<leader>j", "<cmd>Telescope projects<CR>", {desc = "Zoxide"})
...
function GoogleSearch()
    ...
    vim.fn.system('google-chrome-stable "http://google.com/search?q=' ..
                      searchterm .. '" &')
end
